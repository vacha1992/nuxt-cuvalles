<template>
    <!--Todo este container, la data y methods se copiaron tal cual de create(formulario de laboratorios)-->
    <v-container>
...
export default {
    ...
    async beforeMount() {
        //Todo esto de aqui es para tomar los valores del laboratorio a editar y mostrarlos en los inputs
    ...
    //Este modulo de methods se copio de create
    methods: {
        async guardar() {
            try {
